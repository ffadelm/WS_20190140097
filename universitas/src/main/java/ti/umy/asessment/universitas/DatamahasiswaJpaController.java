 ...
 */
package ti.umy.asessment.universitas;
...
import ti.umy.asessment.universitas.exceptions.NonexistentEntityException;
import ti.umy.asessment.universitas.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.umy.asessment_universitas_jar_0.0.1-SNAPSHOTPU");
